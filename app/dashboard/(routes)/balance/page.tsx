...
export default function BalancePage() {
  ...
  const orangeCashNumber = "01225502427";
  const whatsappNumber = "01206053848";
  const whatsappLink = `https://wa.me/201206053848`;
        ...
        <Card className="border-brand/20 bg-brand/5">
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              إضافة رصيد عبر أورنج كاش أو الدفع في السنتر
            </CardTitle>
            <CardDescription>
              قم بتحويل المبلغ إلى الرقم التالي أو الدفع في السنتر ثم أرسل صورة الإيصال
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="bg-card rounded-lg p-4 border-2 border-brand/30">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-muted-foreground mb-1">رقم أورنج كاش</p>
                  <p className="text-2xl font-bold text-brand">{orangeCashNumber}</p>
                </div>
                <Button
                  variant="outline"
                  size="icon"
                  onClick={() => copyToClipboard(orangeCashNumber, setCopiedOrange)}
                  className="h-10 w-10"
                >
                  {copiedOrange ? (
            ...
            <div className="bg-muted/50 rounded-lg p-4 space-y-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground">
                <li>قم بتحويل المبلغ المطلوب إلى رقم أورنج كاش أعلاه أو الدفع في السنتر</li>
                <li>احفظ صورة إيصال التحويل من التطبيق (إن وجد)</li>
